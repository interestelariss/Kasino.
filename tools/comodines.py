...
COMODINES = [
    ...
    J("bufon_siniestro", "Bufón Siniestro", 2, 6,
      [XMULT % 1 + " si aún no has", "conseguido la {C:attention}mitad{} de la ciega"], {"xmult": 2}, ["xmult"],
    ...
    J("bufon_bicolor", "Bufón Bicolor", 2, 6,
      [XMULT % 1 + " si todas las cartas", "puntuadas son {C:attention}pares{}"], {"xmult": 1.5}, ["xmult"],
    ...
    J("bufon_estrella", "Bufón Estrella", 2, 6,
      [XMULT % 1 + " si la mano puntuada", "tiene {C:attention}#2#{} Ases o más"], {"xmult": 2, "min": 2}, ["xmult", "min"],
    ...
    J("arlequin", "Arlequín", 2, 6,
      ["{X:mult,C:white} +X#1# {} multi por cada", "comodín a su {C:attention}izquierda{}"], {"step": 0.2}, ["step"],
    ...
    J("tigre", "Tigre", 3, 8,
      [XMULT % 1 + " si la mano contiene", "una {C:attention}Escalera{} con un {C:attention}As{}"], {"xmult": 3}, ["xmult"],
    ...
    J("bufon_venenoso", "Bufón Venenoso", 1, 5,
      [XMULT % 1 + " si la mano puntuada", "tiene {C:attention}#2#{} o más " + PALO["Clubs"]], {"xmult": 1.5, "min": 3},
      ["xmult", "min"],
    ...
    J("bufon_rubi", "Bufón Rubí", 2, 6,
      [XMULT % 1 + " si la mano puntuada", "tiene exactamente {C:attention}un{} {C:hearts}Corazón{}"], {"xmult": 2}, ["xmult"],
    ...
    J("enterrador", "Enterrador", 3, 8,
      ...
      {"gain": 0.2, "xmult": 1}, ["gain", "xmult"], "KAS.scale{ field = 'xmult', on = KAS.T.remove_cards }"),
    ...
    J("mago_moneda", "Mago de la Moneda", 2, 7,
      ["{X:mult,C:white} +X#1# {} multi por cada", "{C:money}$#2#{} que tengas"], {"step": 0.1, "per": 10}, ["step", "per"],
    ...
    J("calaverita", "Calaverita", 2, 6,
      [XMULT % 1 + " si todas las cartas", "puntuadas son {C:attention}impares{}"], {"xmult": 1.5}, ["xmult"],
    ...
    J("farolero", "Farolero", 2, 6,
      [XMULT % 1 + " si quedan {C:attention}#2#{}", "cartas o menos en tu baraja"], {"xmult": 1.5, "cards": 10},
    ...
    J("pulpo", "Pulpo", 1, 5,
      [XMULT % 1 + " si la mano puntuada", "tiene {C:attention}dos 8{} o más"], {"xmult": 1.8}, ["xmult"],
    ...
    J("bufon_ajedrecista", "Bufón Ajedrecista", 2, 7,
      ...
      {"xmult": 2, "chips": 60, "count": 0}, ["xmult", "chips"],
      "function(self, card, context) local e = card.ability.extra "
