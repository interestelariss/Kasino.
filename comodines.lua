...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 1.25, cards = 5 } },
        rarity = 2,
        cost = 6,
        atlas = "cartas",
        pos = { x = 2, y = 7 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 1.3, cards = 10 } },
        rarity = 2,
        cost = 6,
        atlas = "cartas",
        pos = { x = 4, y = 8 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 1.5, chips = 60, count = 0 } },
        rarity = 2,
        cost = 7,
        atlas = "cartas",
        pos = { x = 5, y = 9 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { gain = 0.02, xmult = 1 } },
        rarity = 3,
        cost = 8,
        atlas = "cartas2",
        pos = { x = 0, y = 0 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 1.25, min = 20 } },
        rarity = 2,
        cost = 6,
        atlas = "cartas2",
        pos = { x = 3, y = 0 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 2, break_odds = 4 } },
        rarity = 3,
        cost = 8,
        atlas = "cartas3",
        pos = { x = 12, y = 0 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 1.25, cards = 4 } },
        rarity = 2,
        cost = 6,
        atlas = "cartas3",
        pos = { x = 11, y = 1 },
...
do
    SMODS.Joker {
        ...
        config = { extra = { xmult = 1.5, loss = 0.05, gain = -0.05 } },
        rarity = 2,
        cost = 6,
        atlas = "cartas3",
        pos = { x = 8, y = 3 },
